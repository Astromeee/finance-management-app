...
// The native marker lets that page hand the one-time PKCE code back to either native app.
// Keep the existing marker so the deployed web callback works with iOS as well.
