...
const categoryRules: Array<{ icon: LucideIcon; pattern: RegExp }> = [
  ...
  { pattern: /salary|paycheck|wage/i, icon: BadgeDollarSign },
  { pattern: /client|work|business|freelance/i, icon: BriefcaseBusiness },
  { pattern: /gift/i, icon: Gift },
  { pattern: /refund|reimburse/i, icon: RotateCcw },
