  ...
  return (
    <div className="chart-frame chart-frame-donut">
      <ResponsiveContainer width="100%" height="100%">
        <PieChart>
          <Pie data={categorySpend} dataKey="value" nameKey="name" innerRadius="52%" outerRadius="78%" paddingAngle={4} isAnimationActive={false}>
...
export function WeeklyLine() {
  return (
    <div className="chart-frame">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={weeklyTrend} margin={{ top: 8, right: 8, left: -18, bottom: 0 }}>
...
export function IncomeBars() {
  return (
    <div className="chart-frame chart-frame-bars">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={incomeBreakdown} margin={{ top: 8, right: 8, left: -18, bottom: 0 }}>
          <CartesianGrid stroke="rgba(255,255,255,.08)" vertical={false} />
