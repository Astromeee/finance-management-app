    ...
    return (
      <main className="grid min-h-screen place-items-center bg-[var(--bg-deep)] p-5">
        <section className="card max-w-md p-6 text-center" role="alert">
          ...
          <h1 className="mt-2 text-2xl font-semibold text-[#F8F4EC]">Pocket Ledger could not open this screen.</h1>
          <p className="mt-3 text-sm text-[#B3A793]">Your saved data has not been changed. Reload the app to try again.</p>
