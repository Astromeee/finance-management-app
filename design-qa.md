...
- Copy and content: Home copy and financial examples match the supplied desktop reference; the remaining screens use the package's corresponding labels and realistic values.
...
- Home and Record visual comparison: passed.
